...
class MainActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == ADD_REQUEST && resultCode == Activity.RESULT_OK) {
            val newphone = phone(
                data!!.getStringExtra(addeditactivity.EXTRA_JUDUL).toString(),
                data.getStringExtra(addeditactivity.EXTRA_DESKRIPSI).toString(),
                data.getStringExtra(addeditactivity.EXTRA_TELP).toString(),
                data.getStringExtra(addeditactivity.EXTRA_GMAIL).toString())
